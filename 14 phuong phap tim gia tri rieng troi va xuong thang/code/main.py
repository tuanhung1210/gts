...
# Load file
f = open("c:\\Users\\ADMIN\\Desktop\\GTS anh Ba Anh\\14 phuong phap tim gia tri rieng troi va xuong thang\\code\\inputA.txt","r")
temp = sys.stdout                 # store original stdout object for later
sys.stdout = open('c:\\Users\\ADMIN\\Desktop\\GTS anh Ba Anh\\14 phuong phap tim gia tri rieng troi va xuong thang\\code\\output.txt','w')
a = f.readline()
n =  int(a)
